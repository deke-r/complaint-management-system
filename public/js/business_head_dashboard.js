...
$(document).ready(function(){
    ...
    let in_process_count1= $('#in_process_count1').text().trim();
    let resolved_count1= $('#resolved_count1').text().trim();
    let closed_count1= $('#closed_count1').text().trim();
    ...
    if( in_process_count1 == ''){
      $('#in_process_count1').html('0');
    }
    if( resolved_count1 == ''){
      $('#resolved_count1').html('0');
    }
    if( closed_count1 == ''){
      $('#closed_count1').html('0');
    }
