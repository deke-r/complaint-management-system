...
$(document).ready(function () {
    $(document).on('change', '#yourSelectId, #ticket_type_dd, #ticket_type1_dd, #ticket_location', function () {
        ...
        let ticket_location = $('#ticket_location').val();
        // console.log(ticket_type, ticket_type_dd, ticket_type_dd1, ticket_location ,'dwjfjficjeooejo')
                    ...
                    $('#append_cr').empty().append(
                        ...
                        <div class="row  py-2">
                            <div class="col-md-4 my_cols">
                                ...
                                <input type="file" name="Attachment1" id="Attachment1" accept="image/* " capture="environment" class="form-control border-leftb box_sdw11 f_13 fw_600" placeholder="" required>
                                
                            </div>
                            <div class="col-md-4 my_cols">
                                <h6 class="fw_bold f_13 ms-1 ">Product Photo(Image 2): <span class="text-danger">*</span></h6>
                                <input type="file" name="Attachment2" id="Attachment2" accept="image/*" capture="environment" class="form-control border-leftb box_sdw11 f_13 fw_600" placeholder="" required>
                                
                            </div>
                            <div class="col-md-4 my_cols">
                                <h6 class="fw_bold f_13 ms-1 ">Product Video: </h6>
                                <input type="file" name="Attachment3" id="Attachment3" accept="video/*" capture="environment" class="form-control border-leftb box_sdw11 f_13 fw_600" placeholder="" >
    ...
    if (allFieldsFilled && quantity_Purchase >= quantity_Rejected) {
        ...
        if (quantity_Purchase < quantity_Rejected) {
            ...
            $('#quantity_alert').attr('hidden', true);
                        ...
                        .then(data => {
                            console.log('Success:_fjajjjalfjfafjdkalsfldfjdsl', data);
                ...
                // ----------Email function start----------
                function sendEmail(ticket_data,emp_id) {
                    fetch('/send-email-connect', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                        },
                        body: JSON.stringify({ ticket_data,emp_id}),
                    })
