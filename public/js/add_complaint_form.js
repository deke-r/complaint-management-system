            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    $('#append_cr').empty().append(
                        ...
                        <div class="row  py-2">
                            <div class="col-md-4 my_cols">
                                <h6 class="fw_bold f_13 ms-1 ">Product Photo(Image 1):</h6>
                            ...
                            <div class="col-md-4 my_cols">
                                <h6 class="fw_bold f_13 ms-1 ">Product Photo(Image 2):</h6>
                            ...
                            <div class="col-md-4 my_cols">
                                ...
                                <input type="file" name="Attachment3" id="Attachment3" accept="image/*, video/*, .pdf" capture="environment" class="form-control border-leftb box_sdw11 f_13 fw_600" placeholder="" required>
                    ...
                    $(document).ready(function () {
                        ...
                        $('#sub_btn').on('click', function () {
                          ...
                          formData.append('emp_name', $('#user_name').val());
                        ...
                        .then(data => {
                            ...
                            Swal.fire({
                                ...
                                text: 'Your Complaint has been submitted successfully. Ticket ID: ' + ticketId,
                            })
                            .then(() => {
                               
                                location.reload(true);
                            });
                            sendEmail(ticketId,user_id,user_name);
                        })
                        .catch(error => {
                    ...
                    function sendEmail(ticketId,user_id,user_name) {
                        fetch('/send-email', {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json',
                            },
                            body: JSON.stringify({ ticketId,user_id,user_name }),
                        })
